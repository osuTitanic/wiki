...
If you are completely new to osu!, it is recommended that you play the tutorial first ([Peter Lambert - osu! tutorial](https://osu.titanic.sh/s/3756)). After [downloading and installing](https://osu.titanic.sh/wiki/en/Installation) osu!, there will be a massive osu! button in the middle. Just click on it twice and choose "Solo" mode. You can easily search for a beatmap in the library just by typing it out, but what you're looking for right now is the "Tutorial". Since this is your first-time, the only beatmap inside is "[Peter Lambert - osu! tutorial](https://osu.titanic.sh/s/3756)". The beatmap will teach you about the fundamental of osu!standard play such as [Hit-circles](https://osu.ppy.sh/wiki/en/Gameplay/Hit_object/Hit_circle), [Sliders](https://osu.ppy.sh/wiki/en/Gameplay/Hit_object/Slider) and [Spinners](https://osu.ppy.sh/wiki/en/Gameplay/Hit_object/Spinner). For playing techniques, you have to learn as you go, as they can't be taught verbally.
