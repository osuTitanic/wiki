...
5. **Usurpation d'identité malicieuse**  
	Usurpé l'identité d'une autre personne est strictement interdit. Tout essaie de se présenté en tant qu'une autre personne avec l'intention de manipuler ou de fair du mal résulterat en une restriction immédiate. Oui, cela veux dire que vous nommez "BRMC" et faire de la pub pour votre arnaque de crypto n'est pas autorisée.

6. Les **clients osu! modifié** *sont* permis sur Titanic, mais ils doivent d'abords être approuvé par un administrateur du serveur avant sonn utilisation. Tout essaie d'éluder à ce requiereme t résulterat en une restriction.

7. **Abus intentionnel des serveurs.**  
	Déliberemment essayer de surcharger, DDoS ou par d'autres moyen déstabiliser les serveurs de Titanic sont strictement interdit et resulteronts en une restriction. de compte.

8. Faire de **pubs non solicité** est interdit sur Titanic. Tout contenue promotionelle doit être pré-approuvé par un membre du personel avant s'être posté. Brisé cette règle peut réduire votre contenau silence.
...
3. **Ne continuez pas d'envoyer des messages ou d'harcemer des utilisateurs après avoir été blocké.**  
	Si un utilisateurs vous blocks, cela veut dire qu'ils ne veuilles plus communiqué. Essayer d'outre-passer ce blockage - surtout pour harceler, déranger, troller, ou les provoquer - est une violation serieuses du comportement en jeu. Cette attitude résultera en une réduction au silence ou d'autres punitions, si quelqu'un vous harcèle ou menace votre sécurité, s'il vous-plaît, ouvrez un ticket dans le [serveur Discord de Titanic](https://discord.gg/qryYG2C5nc) ou contacté l'[e-mail de support](mailto:support@titanic.sh).
...
- Écrire un e-mail à l'[e-mail de support](mailto:support@titanic.sh).
